...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-10 px-4 text-left align-middle table-header [&:has([role=checkbox])]:pr-0 border-r last:border-none w-auto",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "px-4 py-2 align-middle text-[11px] [&:has([role=checkbox])]:pr-0 border-r last:border-none",
      className,
    )}
    {...props}
  />
