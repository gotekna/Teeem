  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="border-t border-border">
        ...
        {/* Debug Tools - dev/staging only - 3 equal buttons */}
        {(isExpanded || mobile) && isDevOrStaging && (
          <div className="px-3 py-2 grid grid-cols-3 gap-1">
            <button
              onClick={handleCopyConsole}
              className={cn(
                "flex items-center justify-center gap-1 py-1.5 rounded text-[10px] font-medium transition-all border",
                copiedConsole
            ...
            <button
              ...
              disabled={clearing}
              className={cn(
                "flex items-center justify-center gap-0.5 py-1.5 rounded text-[10px] font-medium transition-all border",
                clearing
                  ? "bg-green-600 text-white border-green-600"
                  : "bg-red-100 text-red-600 border-red-300 dark:bg-red-900/30 dark:text-red-400 dark:border-red-800 hover:bg-red-200 dark:hover:bg-red-900/50"
              )}
