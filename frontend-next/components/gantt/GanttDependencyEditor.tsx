...
import { DependencyInfoPanel, DEPENDENCY_GRID_COLS_EDITABLE } from '@/components/schedule/DependencyInfoPanel';
    ...
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="max-w-6xl max-h-[90vh] flex flex-col">
        ...
        <div className="flex-1 flex gap-4 min-h-0">
          {/* Left Sidebar - Shared Info Panel (SSoT: DependencyInfoPanel) */}
          <DependencyInfoPanel showDragGuide={true} />
