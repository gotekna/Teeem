 ...
 *
 * Reusable tab components extracted from page files for the unified tab system.
 * Components here are registered in lib/tab-component-registry.ts for dynamic rendering.
 */
...
export { ShareholdingsTab } from "./ShareholdingsTab";
