...
function getTrendIcon(trend?: string) {
  switch (trend) {
    case "up":
      return <TrendingUp className="h-3 w-3 text-green-500 dark:text-green-400" />;
    case "down":
            ...
            <div className="mb-4 p-3 rounded-lg bg-secondary/50">
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2">
                  <Bot className={cn(
                    "h-5 w-5",
                    systemWinning ? "text-purple-600 dark:text-purple-400" : "text-muted-foreground"
                  )} />
                ...
                <div className="flex items-center gap-2">
                  <span className={cn(
                    "font-mono font-bold",
                    !systemWinning ? "text-blue-600 dark:text-blue-400" : "text-muted-foreground"
                  )}>
                    {humansPoints} pts
                  </span>
              ...
              <p className={cn(
                ...
                systemWinning ? "text-purple-600 dark:text-purple-400" : "text-blue-600 dark:text-blue-400"
              )}>
                {systemWinning ? (
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    {entry.isSystem ? (
                      ...
                      <div className={cn(
                        ...
                        entry.isCurrentUser
                          ? "bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 dark:bg-blue-900 dark:text-blue-300"
              ...
              <div className="mt-2 pt-2 border-t border-dashed">
                <div className="flex items-center justify-between py-2 px-2 rounded bg-blue-50 dark:bg-blue-950/30">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="w-6 h-6 rounded-full flex items-center justify-center text-xs font-medium bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 dark:bg-blue-900 dark:text-blue-300">
                      Y
                    </div>
