...
> = {
  marketing: {
    ...
    shortLabel: "Mkt",
    icon: Megaphone,
    className: "bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 dark:bg-purple-900/30 dark:text-purple-400",
  },
  spam: {
    label: "Spam",
    shortLabel: "Spam",
  ...
  business: {
    ...
    shortLabel: "Biz",
    icon: Briefcase,
    className: "bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 dark:bg-blue-900/30 dark:text-blue-400",
  },
  transactional: {
    label: "Transactional",
    shortLabel: "Txn",
    icon: ShoppingCart,
    className: "bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-300 dark:bg-amber-900/30 dark:text-amber-400",
  },
  personal: {
    label: "Personal",
    shortLabel: "Pers",
    icon: Mail,
    className: "bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 dark:bg-green-900/30 dark:text-green-400",
  },
  newsletter: {
    label: "Newsletter",
    shortLabel: "News",
  ...
  notification: {
    ...
    shortLabel: "Notif",
    icon: Mail,
    className: "bg-muted text-foreground dark:bg-card/50 dark:text-muted-foreground",
  },
};
