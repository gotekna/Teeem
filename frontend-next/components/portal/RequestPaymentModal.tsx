                ...
                {loadingPOs ? (
                  ...
                  <form onSubmit={handleSubmit} className="mt-6 space-y-6">
                    ...
                    <div>
                      ...
                      <Listbox value={selectedPO} onChange={setSelectedPO}>
                        <div className="relative mt-1">
                          <Listbox.Button className="relative w-full cursor-default rounded-md border border-border bg-white py-2 pl-3 pr-10 text-left shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 sm:text-sm">
                            <span className="block truncate">
                              {selectedPO
                                ? `PO #${selectedPO.purchase_order_number} - ${selectedPO.construction_name} (${formatCurrency(selectedPO.remaining_amount)} remaining)`
                    ...
                    <div>
                      ...
                      <div className="mt-1 relative rounded-md shadow-sm">
                        ...
                        <input
                          ...
                          className="block w-full rounded-md border-border pl-7 pr-12 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                          placeholder="0.00"
                          required
                        />
                      </div>
                    ...
                    <div className="mt-5 sm:mt-6 sm:grid sm:grid-flow-row-dense sm:grid-cols-2 sm:gap-3">
                      ...
                      <button
                        type="button"
                        className="mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-foreground shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-muted sm:col-start-1 sm:mt-0"
                        onClick={onClose}
                      >
                        Cancel
                      </button>
