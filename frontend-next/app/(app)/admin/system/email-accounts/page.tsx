      ...
      <div className="flex items-center justify-between">
        <div>
          <p className="text-muted-foreground">
            PolarisMail reseller - manage email subscriptions and migrations
          </p>
        </div>
        <div className="flex gap-2">
          ...
          <Button onClick={() => router.push("/admin/system/email-accounts/new")} size="sm">
              ...
              {subscriptions.length === 0 ? (
                ...
                subscriptions.map((sub) => (
                  <TableRow
                    ...
                    onClick={() => router.push(`/admin/system/email-accounts/${sub.id}`)}
                  >
