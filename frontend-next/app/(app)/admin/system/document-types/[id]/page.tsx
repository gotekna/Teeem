...
const BASE_PLACEHOLDERS: { company: PlaceholderItem[]; job: PlaceholderItem[] } = {
  company: [
    ...
    { code: "{Quarter}", example: "Q2", longCode: "{QuarterLong}", longExample: "Q2 Oct-Dec", color: "purple" },
    { code: "{Month}", example: "Oct", longCode: "{MonthLong}", longExample: "October", color: "purple" },
    { code: "{MonthNum}", example: "10", longCode: "{MonthNumLong}", longExample: "10", color: "purple" },
    { code: "{Year}", example: "25", longCode: "{YearLong}", longExample: "2025", color: "purple" },
    { code: "{Week}", example: "W42", longCode: "{WeekLong}", longExample: "Week 42", color: "purple" },
    ...
    { code: "{YearMonth}", example: "2025-10", longCode: "{YearMonthLong}", longExample: "2025 October", color: "purple" },
    ...
    { code: "{MMDDYYYY}", example: "10-09-2025", longCode: "{DateUS}", longExample: "October 9, 2025", color: "purple" },
    { code: "{Semester}", example: "S1", longCode: "{SemesterLong}", longExample: "Semester 1 Jul-Dec", color: "purple" },
    { code: "{BiMonth}", example: "B5", longCode: "{BiMonthLong}", longExample: "Sep-Oct", color: "purple" },
