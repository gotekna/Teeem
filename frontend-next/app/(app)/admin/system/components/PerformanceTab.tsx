...
export function PerformanceTab() {
  ...
  return (
    <div className="space-y-6">
        ...
        <Card className={cn(
          ...
          <CardContent>
            ...
            <div className="grid grid-cols-4 gap-4 mb-4">
              <div className="text-center p-3 bg-muted dark:bg-card/50 rounded-lg">
            ...
            {/* Compliance Bar */}
            <div className="mb-4">
              <div className="h-3 rounded-full overflow-hidden bg-muted dark:bg-muted">
                <div
                  className={cn(
              ...
              {webVitals.map((vital) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Distribution bar */}
                    <div className="mt-3 h-2 rounded-full overflow-hidden flex bg-muted dark:bg-muted">
                      <div
              ...
              {trends.slice(-12).map((trend, index) => {
                ...
                return (
                  <div key={index} className="flex items-center gap-3">
                    ...
                    <div className="flex-1 h-6 bg-muted dark:bg-card rounded overflow-hidden">
                      <div
                        className={cn(
                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      slo.status === "no_data" && "border-border dark:border-border bg-muted dark:bg-card/50"
                    )}
                  >
                    ...
                    <div className="mt-2">
                      ...
                      <div className="h-2 rounded-full overflow-hidden bg-muted dark:bg-muted">
                        <div
                          className={cn(
                            "h-full rounded-full transition-all",
      ...
      {/* Performance Tips */}
      <Card className="bg-muted dark:bg-background/50 border-border dark:border-border">
        <CardHeader className="pb-3">
