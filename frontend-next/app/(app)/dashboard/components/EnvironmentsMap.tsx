...
const ENVIRONMENTS: EnvironmentStatus[] = [
  ...
  },
  {
    ...
    branch: "Staging",
    backendUrl: "https://teeem-staging-worker-b9f0eec77a7c.herokuapp.com",
    description: "Background jobs: PDF generation, OCR, document processing",
    status: "checking",
  },
  {
    name: "Beta Worker",
    type: "worker",
    herokuApp: "teeem-beta-worker",
    branch: "Beta",
    backendUrl: "",
    description: "Background jobs for beta (not yet created)",
    status: "unknown",
  },
  {
    ...
    branch: "Live",
    backendUrl: "",
    description: "Background jobs for production (not yet created)",
    status: "unknown",
  },
];
