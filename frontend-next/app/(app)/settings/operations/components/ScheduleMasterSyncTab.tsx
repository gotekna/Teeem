...
const SM_SYNC_TABLES = [
  ...
  { key: "cost_centres", label: "Cost Centres", defaultMode: "two_way" as const },
  { key: "supervisor_checklist_templates", label: "Checklists", defaultMode: "two_way" as const },
  { key: "document_types", label: "Document Types", defaultMode: "two_way" as const },
  ...
  { key: "sm_schedule_master_related_pos", label: "Related PO Links", defaultMode: "two_way" as const },
  ...
  { key: "po_template_packs", label: "PO Template Packs", defaultMode: "two_way" as const },
  { key: "po_template_items", label: "PO Template Items", defaultMode: "two_way" as const },
  { key: "po_template_line_items", label: "PO Line Items", defaultMode: "two_way" as const },
  { key: "quote_templates", label: "Quote Templates (Std)", defaultMode: "two_way" as const },
  { key: "custom_quote_templates", label: "Quote Templates (Custom)", defaultMode: "two_way" as const },
  { key: "tender_headers", label: "Tender Headers", defaultMode: "two_way" as const },
  { key: "tenders", label: "Tender Sections", defaultMode: "two_way" as const },
  { key: "claim_stage_templates", label: "Claim Templates", defaultMode: "two_way" as const },
  { key: "claim_stage_template_lines", label: "Claim Template Lines", defaultMode: "two_way" as const },
  { key: "foundation_views", label: "Global Views", defaultMode: "two_way" as const },
] as const;
