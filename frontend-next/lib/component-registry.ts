...
const TIER_3_COMPONENTS: StandardComponent[] = [
  ...
  },
  {
    ...
    description: "Lightweight view-only table with virtualization. Same styling as TeeemTableView.",
    whenToUse: "Read-only tables, external API data, tables without Foundation.",
    usageCount: 0,
  },
  {
    id: "sheet",
