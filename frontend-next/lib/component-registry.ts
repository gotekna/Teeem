...
const TIER_1_COMPONENTS: StandardComponent[] = [
  ...
  // URL State Hooks
  {
    id: "use-path-tabs",
    name: "usePathTabs",
    displayName: "Path Tabs Hook",
    category: "hooks",
    tier: 1,
    status: "standard",
    importPath: "@/hooks/usePathTabs",
    description: "SSoT hook for path-based tab navigation. Uses /page/tab instead of ?tab=xxx for clean, human-readable URLs.",
    whenToUse: "NEW tab navigation. Preferred over useUrlTabs for cleaner URLs.",
    usageCount: 0,
  },
  {
    id: "use-url-tabs",
    name: "useUrlTabs",
    displayName: "URL Tabs Hook (Legacy)",
    category: "hooks",
    tier: 2,
    status: "deprecated",
    importPath: "@/hooks/useUrlTabs",
    description: "Legacy hook for syncing tab state to URL query params (?tab=xxx).",
    whenToUse: "LEGACY ONLY. Use usePathTabs for new tabs. Query param URLs are being migrated to path-based.",
    usageCount: 12,
  },
  {
    id: "use-url-state",
...
const TIER_2_COMPONENTS: StandardComponent[] = [
  ...
  {
    id: "combobox-dropdown-multi",
    name: "ComboboxDropdownMulti",
    displayName: "Multi-Select Searchable",
    category: "forms",
    tier: 2,
    status: "standard",
    importPath: "@/components/ui/combobox-dropdown-multi",
    description: "Multi-select dropdown with popover, search, checkboxes, and badges. Mirrors ComboboxDropdown pattern.",
    whenToUse: "Multiple selection from a list with search. Uses ComboboxItem type for consistency.",
    deprecates: ["multiple-selector"],
    usageCount: 2,
  },
  {
    id: "supplier-picker",
...
const TIER_4_COMPONENTS: StandardComponent[] = [
  ...
  },
  {
    ...
    displayName: "Document Edit Modal",
    category: "document",
    tier: 4,
    status: "standard",
    importPath: "@/components/corporate/DocumentEditModal",
    description: "Full document editing modal with PDF viewer, AI classification, and metadata",
    whenToUse: "Edit document metadata, AI verification, classification",
    usageCount: 1,
  },
  {
    id: "document-list-view",
    name: "DocumentListView",
    displayName: "Document List View",
    category: "document",
    tier: 4,
    status: "standard",
    importPath: "@/components/ui/document-list-view",
    description: "Split-view document list with 30% list / 70% preview layout. Supports selection, rename, approve, bulk actions.",
...
const TIER_5_COMPONENTS: StandardComponent[] = [
  ...
  // Placeholder Pattern Components (renamed from Token to Placeholder Jan 2026)
  {
    id: "placeholder-builder",
    name: "PlaceholderBuilder",
    displayName: "Placeholder Builder",
    category: "templates",
    tier: 5,
    status: "standard",
    importPath: "@/components/ui/placeholders",
    description: "Draggable placeholders with SHORT/LONG variants and preview",
    whenToUse: "Build template strings with placeholders (file names, display names)",
  },
  {
    id: "placeholder-palette",
    name: "PlaceholderPalette",
    displayName: "Placeholder Palette",
    category: "templates",
    tier: 5,
    status: "standard",
    importPath: "@/components/ui/placeholders",
    description: "Searchable palette of available placeholders",
    whenToUse: "Show available placeholders for placeholder builder",
  },
  {
    id: "placeholder-badge",
    name: "PlaceholderBadge",
    displayName: "Placeholder Badge",
    category: "templates",
    tier: 5,
    status: "standard",
    importPath: "@/components/ui/placeholders",
    description: "Individual draggable placeholder badge with remove button",
    whenToUse: "Represent a single placeholder in placeholder builder",
  },
...
export const DEPRECATED_COMPONENTS: DeprecatedComponent[] = [
  ...
  // Token → Placeholder rename (Jan 2026)
  {
    id: "token-builder",
    name: "TokenBuilder",
    importPath: "@/components/ui/tokens",
    replacedBy: "placeholder-builder",
    reason: "Renamed for terminology consistency. Backwards compat alias exists.",
    migrationGuide: "Change import from @/components/ui/tokens to @/components/ui/placeholders and rename TokenBuilder to PlaceholderBuilder.",
  },
  {
    id: "token-palette",
    name: "TokenPalette",
    importPath: "@/components/ui/tokens",
    replacedBy: "placeholder-palette",
    reason: "Renamed for terminology consistency. Backwards compat alias exists.",
    migrationGuide: "Change import from @/components/ui/tokens to @/components/ui/placeholders and rename TokenPalette to PlaceholderPalette.",
  },
  {
    id: "token-badge",
    name: "TokenBadge",
  ...
  },
  {
    ...
    replacedBy: "combobox-dropdown-multi",
    reason: "ComboboxDropdownMulti uses popover pattern (floats above content) instead of inline expansion that covers modals. Uses ComboboxItem type for consistency with ComboboxDropdown.",
    migrationGuide: "Replace MultipleSelector with ComboboxDropdownMulti. Change `value`→`selectedItems`, `options`→`items`, `onChange`→`onSelectionChange`. Convert Option {value,label,disable} to ComboboxItem {id,label,disabled}.",
  },
