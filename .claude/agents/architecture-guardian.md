...
- Fetch Bible (RULES): GET https://teeemlive-ce8e2660a615.herokuapp.com/api/v1/trinity?category=bible
- Fetch Teacher (HOW-TO): GET https://teeemlive-ce8e2660a615.herokuapp.com/api/v1/trinity?category=teacher
- Fetch Lexicon (KNOWLEDGE): GET https://teeemlive-ce8e2660a615.herokuapp.com/api/v1/trinity?category=lexicon
