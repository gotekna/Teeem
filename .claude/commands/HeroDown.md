...
Pull the production database (teeem-production) to both local environment AND teeem-sam-dev.
...
heroku pg:copy teeem-production::DATABASE_URL DATABASE_URL --app teeem-sam-dev --confirm teeem-sam-dev 2>&1 | tail -10
...
| 3 | teeem-production | teeem-sam-dev | `pg:copy` (Heroku-to-Heroku, fast) |
