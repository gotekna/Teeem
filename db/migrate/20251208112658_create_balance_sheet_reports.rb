...
class CreateBalanceSheetReports < ActiveRecord::Migration[8.0]
  def change
    create_table :balance_sheet_reports do |t|
      ...
      t.decimal :total_assets, precision: 15, scale: 2, default: 0
      t.decimal :total_liabilities, precision: 15, scale: 2, default: 0
      t.decimal :net_assets, precision: 15, scale: 2, default: 0
