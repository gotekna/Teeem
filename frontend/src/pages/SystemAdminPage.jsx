...
export default function SettingsPage() {
  ...
  // Map tab names to indices - REORGANIZED: 15 tabs (Documentation moved to Company sub-tab)
  const tabs = [
    'company',
    'schedule-master',
    'sm-gantt-v2',
  ...
  return (
    <main>
      <TabGroup selectedIndex={selectedIndex} onChange={handleTabChange}>
        ...
        <TabPanels>
          {/* 1. Company Tab with nested sub-tabs (includes Security and Permissions) */}
          <TabPanel>
            <Suspense fallback={<TabLoadingFallback />}>
              <CompanyTab />
            </Suspense>
          ...
          {/* 2. Schedule Master Tab with nested sub-tabs */}
          <TabPanel>
            <Suspense fallback={<TabLoadingFallback />}>
              <ScheduleMasterTabs />
            </Suspense>
          ...
          {/* 10. Developer Tools Tab with nested sub-tabs */}
          <TabPanel>
            <Suspense fallback={<TabLoadingFallback />}>
              <DeveloperToolsTab />
            </Suspense>
