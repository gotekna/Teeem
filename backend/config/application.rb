...
module Backend
  class Application < Rails::Application
    ...
    #
    # Set default timezone (SSoT: TenantSetting::DEFAULT_TIMEZONE)
    # Per-tenant override via TenantSetting.timezone
    config.time_zone = "Australia/Brisbane"  # Must be string literal for Rails boot (before models load)
