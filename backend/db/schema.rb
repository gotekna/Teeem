...
ActiveRecord::Schema[8.0].define(version: 2025_12_24_122624) do
  ...
  create_table "purchase_orders", force: :cascade do |t|
    ...
    t.index ["sm_template_row_id"], name: "index_purchase_orders_on_sm_template_row_id"
