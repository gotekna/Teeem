...
class AddEmailConfigToCorporateCompanySettings < ActiveRecord::Migration[8.0]
  def change
    ...
    add_column :corporate_company_settings, :internal_email_domains, :string,
    ...
    add_column :corporate_company_settings, :monitored_mailbox_pay, :string,
               default: "Pay@tekna.com.au",
               comment: "Mailbox for incoming invoices/bills"

    add_column :corporate_company_settings, :monitored_mailbox_newtask, :string,
               default: "newtask@tekna.com.au",
               comment: "Mailbox for creating new tasks from emails"

    add_column :corporate_company_settings, :monitored_mailbox_newjob, :string,
               default: "newjob@tekna.com.au",
               comment: "Mailbox for creating new jobs from emails"

    add_column :corporate_company_settings, :monitored_mailbox_newcase, :string,
