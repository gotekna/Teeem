...
class ConvertSmTemplateRowsToMultiTemplate < ActiveRecord::Migration[7.0]
  def up
    # Step 1: Add new column for multi-template lookup
    ...
    # Step 3: Add GIN index for efficient JSONB containment queries
    add_index :sm_template_rows, :sm_template_ids, using: :gin

    # Step 4: Drop old unique constraint (sm_template_id, task_number)
