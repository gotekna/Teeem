class AddOcrAndHumanConfidenceToCorporateCompanyDocuments < ActiveRecord::Migration[8.0]
  def change
    ...
    add_column :corporate_company_documents, :ocr_confidence, :decimal, precision: 5, scale: 2
    ...
    add_column :corporate_company_documents, :human_confidence, :decimal, precision: 5, scale: 2
  end
end
