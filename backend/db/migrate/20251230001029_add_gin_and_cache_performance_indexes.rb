class AddGinAndCachePerformanceIndexes < ActiveRecord::Migration[8.0]
  ...
  def change
    ...
    add_index :sm_schedule_masters, :predecessor_ids, using: :gin,
      name: "index_sm_schedule_masters_on_predecessor_ids_gin",
      if_not_exists: true

    add_index :sm_schedule_masters, :sm_template_ids, using: :gin,
      name: "index_sm_schedule_masters_on_sm_template_ids_gin",
      if_not_exists: true
