...
class CreateAssetsFoundation < ActiveRecord::Migration[7.2]
  def up
    ...
    columns_config = [
      ...
      { column_name: "land_area_sqm",      position: 25, column_type: "number",              visible: false, searchable: false, name: "Land Area (sqm)" },
      { column_name: "building_area_sqm",  position: 26, column_type: "number",              visible: false, searchable: false, name: "Building Area (sqm)" },
