...
class RemoveSharepointDefaultFromStorageProvider < ActiveRecord::Migration[7.2]
  def up
    ...
    change_column_default :corporate_company_documents, :storage_provider, from: "sharepoint", to: nil
  ...
  def down
    ...
    change_column_default :corporate_company_documents, :storage_provider, from: nil, to: "sharepoint"
