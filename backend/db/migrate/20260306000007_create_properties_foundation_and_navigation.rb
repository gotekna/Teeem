...
class CreatePropertiesFoundationAndNavigation < ActiveRecord::Migration[8.0]
  def up
    ...
    columns_config = [
      ...
      { column_name: "land_area_sqm",            position: 14, column_type: "decimal_number",      has_ui: true,  searchable: false, name: "Land Area (sqm)" },
      { column_name: "floor_area_sqm",           position: 15, column_type: "decimal_number",      has_ui: true,  searchable: false, name: "Floor Area (sqm)" },
