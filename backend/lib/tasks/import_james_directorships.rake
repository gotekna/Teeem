  ...
  task import_james: :environment do
    ...
    directorships.each_with_index do |dir_data, index|
      ...
      corp_company = if dir_data[:acn]
        ...
        Corporate.find_by("REPLACE(acn, ' ', '') = ?", acn_normalized)
      else
        Corporate.find_by(name: dir_data[:company_name])
      end
    ...
    total_count = james.corporate_directorships.count
    ...
    puts
    puts "=" * 80
    puts "Done! View at: https://teeem.vercel.app/contacts/2165"
    puts "=" * 80
  end
end
