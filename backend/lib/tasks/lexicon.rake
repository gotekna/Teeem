...
namespace :teeem do
  ...
  task import_docs: :environment do
    ...
    unless File.exist?(json_path)
      ...
      puts "Run: bin/rails teeem:export_docs first"
      exit 1
    end
  ...
  desc "Export Lexicon database to TEEEM_LEXICON.md"
  task export_lexicon: :environment do
    ...
    # Header
    content << "# TEEEM LEXICON - Bug History & Knowledge Base"
    content << ""
    ...
    content << ""
    content << "This file is the **knowledge base** for all TEEEM development."
    content << ""
    ...
    content << "- 📖 See [TEEEM_BIBLE.md](TEEEM_BIBLE.md)"
    content << ""
    content << "**For USER GUIDES (how to use features):**"
    content << "- 📘 See [TEEEM_USER_MANUAL.md](TEEEM_USER_MANUAL.md)"
    content << ""
    content << "---"
    content << ""
    ...
    content << "1. Go to Documentation page in TEEEM"
    content << '2. Click "📕 TEEEM Lexicon"'
    content << "3. Use the UI to add/edit/delete entries"
    content << "4. Run `rake teeem:export_lexicon` to update this file"
    content << ""
    ...
    puts "  2. Commit to git: git add TEEEM_DOCS/TEEEM_LEXICON.md"
    puts '  3. Git commit message: "docs: Update Lexicon from database export"'
  end

  desc "Export Teacher database to TEEEM_TEACHER.md"
  task export_teacher: :environment do
    ...
    # Header
    content << "# TEEEM TEACHER - Implementation Patterns & Code Examples"
    content << ""
    content << "**Version:** 1.0.0"
    content << "**Last Updated:** #{Time.current.strftime('%Y-%m-%d %H:%M %Z')}"
    ...
    content << ""
    content << "This file contains **code examples and step-by-step guides** for implementing TEEEM features."
    content << ""
    ...
    content << "- 📕 See [TEEEM_LEXICON.md](TEEEM_LEXICON.md)"
    content << ""
    content << "**For USER GUIDES (how to use features):**"
    content << "- 📘 See [TEEEM_USER_MANUAL.md](TEEEM_USER_MANUAL.md)"
    content << ""
    ...
    content << "**To edit entries:**"
    content << "1. Go to Documentation page in TEEEM"
    content << '2. Click "🔧 TEEEM Teacher"'
    content << "3. Use the UI to add/edit/delete teaching patterns"
    content << "4. Run `rake teeem:export_teacher` to update this file"
    content << ""
    content << "**Single Source of Truth:** Database (not this file)"
    content << ""
    content << "---"
    ...
    content << ""
    content << "**Last Generated:** #{Time.current.strftime('%Y-%m-%d %H:%M %Z')}"
    content << "**Generated By:** `rake teeem:export_teacher`"
    content << "**Maintained By:** Development Team via Database UI"
    content << "**Review Schedule:** After adding new patterns or updating examples"

    # Write to file
    file_path = Rails.root.join("..", "TEEEM_DOCS", "TEEEM_TEACHER.md")
    File.write(file_path, content.join("\n"))
    ...
    puts "💡 Next steps:"
    puts "  1. Review the generated file"
    puts "  2. Commit to git: git add TEEEM_DOCS/TEEEM_TEACHER.md"
  ...
  task export_teacher_split: :environment do
    ...
    teacher_dir = Rails.root.join("..", "TEEEM_DOCS", "TEACHER")
    ...
    chapters.each do |chapter|
      ...
      content << "# TEEEM TEACHER - Chapter #{chapter.chapter_number}: #{chapter.chapter_name}"
      content << ""
      content << "**Last Updated:** #{Time.current.strftime('%Y-%m-%d %H:%M %Z')}"
      content << "**Authority Level:** Reference (HOW to implement Bible rules)"
      content << "**Audience:** Claude Code + Human Developers"
      ...
      content << ""
      content << "**Last Generated:** #{Time.current.strftime('%Y-%m-%d %H:%M %Z')}"
      content << "**Generated By:** `rake teeem:export_teacher_split`"
      content << "**Maintained By:** Development Team via Database UI"
