  ...
  module V1
    class SyncConfigurationsController < ApplicationController
      ...
      def preview
        ...
        links = ContactExternalLink.for_xero_org(tenant_id).enabled
      ...
      def health
        ...
        health_data = {
          ...
          total_linked_contacts: ContactExternalLink.count,
          total_contacts_with_errors: ContactExternalLink.with_errors.count,
          total_contacts_with_conflicts: ContactExternalLink.with_conflicts.count,
          last_sync_activity: ContactExternalLink.maximum(:last_synced_at),
      ...
      def set_sync_configuration
        ...
        unless @sync_configuration
          ...
          link = ContactExternalLink.find_by(xero_org_id: params[:xero_tenant_id])
          tenant_name = link&.tenant_name || "Unknown"
      ...
      def calculate_overall_status
        errors_count = ContactExternalLink.with_errors.count
        conflicts_count = ContactExternalLink.with_conflicts.count
      ...
      def organization_health(config)
        links = ContactExternalLink.for_xero_org(config.xero_tenant_id)
      ...
      def recent_sync_errors
        ContactExternalLink.with_errors
