module Api
  module V1
    # SSoT: Core CRUD operations for Contacts
    # All specialized endpoints are now in Api::V1::Contacts:: namespaced controllers
    # See ADR-001: Contacts Controller Decomposition
