...
# SSoT: Xero Sync concern for ContactsController
# Extracted from contacts_controller.rb to reduce file size and improve maintainability
#
# Methods:
#   - link_to_xero_tenant: POST /api/v1/contacts/:id/link_to_xero_tenant
#   - link_xero_contact: POST /api/v1/contacts/:id/link_xero_contact
#   - sync_from_xero: POST /api/v1/contacts/:id/sync_from_xero
#   - sync_to_xero: POST /api/v1/contacts/:id/sync_to_xero
#   - sync_from_xero_legacy: (private) Legacy sync using xero_id field
#   - sync_addresses_from_xero: (private) Two-way address sync
#
module Contacts
  module XeroSync
