...
class TenantConfigSyncService
  ...
  TABLE_DEFAULT_MODES = {
    "sm_trades"                        => "two_way",
    "sm_stages"                        => "two_way",
    "cost_centres"                     => "two_way",
    "supervisor_checklist_templates"   => "two_way",
    "document_types"                   => "two_way",
    ...
    "sm_schedule_master_related_pos"   => "two_way",
    "sm_hold_reasons"                  => "two_way",
    "sm_resources"                     => "two_way",
    "po_template_packs"                => "two_way",
    "po_template_items"                => "two_way",
    "po_template_line_items"           => "two_way",
    "quote_templates"                  => "two_way",
    "custom_quote_templates"           => "two_way",
    "tender_headers"                   => "two_way",
    "tenders"                          => "two_way",
    "claim_stage_templates"            => "two_way",
    "claim_stage_template_lines"       => "two_way",
    "foundation_views"                 => "two_way",
  }.freeze
