...
class DocumentStorageService
  ...
  def upload(scope:, record:, file:, tokens: {}, filename: nil, content_type: nil)
    ...
    if existing_blob
      ...
      # SSoT (Feb 2026): Pass record so we can use its WarehouseFolder.full_folder_path template
  ...
  # SSoT (Feb 2026): Pass record to use its WarehouseFolder.full_folder_path template
  ...
  # 1. Record's storage_folder_template (from WarehouseFolder.full_folder_path - database)
