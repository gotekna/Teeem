...
# TEEEM Development Servers Startup Script
# This script starts both the Rails backend and Vite frontend servers

PROJECT_DIR="/Users/robdev/Documents/GitHub/teeem"
LOG_DIR="$PROJECT_DIR/logs"

# Create logs directory if it doesn't exist
mkdir -p "$LOG_DIR"

echo "Starting TEEEM development servers..."
